...
def save_artist(group_id, initial):
    ...
    for artist in artists:
        ...
        # print(type(artist_id), type(artist_name))
        try:
            sql.insert_artist(int(artist_id), str(artist_name))
        except Exception as e:
            # 打印错误日志
            print(e)


# 热门的从1001&initial=-1 开始
# 华语男歌手从1001&initial=65 开始
# 实际上,歌手是从1001 1002 2001这样增长的
gg = 1001
save_artist(gg, -1)
